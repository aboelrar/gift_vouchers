...
public class login_rootBody{
	...
	public void setUser(login_rootUser user){
		this.user = user;
	}
	public login_rootUser getUser(){
		return this.user;
	}
	 ...
	 */
	public login_rootBody(JSONObject jsonObject){
		if(jsonObject == null){
			return;
		}
		...
		user = new login_rootUser(jsonObject.optJSONObject("user"));
	}
