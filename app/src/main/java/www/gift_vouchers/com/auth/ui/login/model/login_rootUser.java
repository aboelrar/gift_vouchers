...
public class login_rootUser{
	...
	public void setRole(login_rootRole role){
		this.role = role;
	}
	public login_rootRole getRole(){
		return this.role;
	}
	 ...
	 */
	public login_rootUser(JSONObject jsonObject){
		if(jsonObject == null){
			return;
		}
		...
		role = new login_rootRole(jsonObject.optJSONObject("role"));
	}
