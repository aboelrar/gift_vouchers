...
public class UserInfoBody{
	...
	public void setRole(UserInfoRole role){
		this.role = role;
	}
	public UserInfoRole getRole(){
		return this.role;
	}
	 ...
	 */
	public UserInfoBody(JSONObject jsonObject){
		if(jsonObject == null){
			return;
		}
		...
		role = new UserInfoRole(jsonObject.optJSONObject("role"));
	}
