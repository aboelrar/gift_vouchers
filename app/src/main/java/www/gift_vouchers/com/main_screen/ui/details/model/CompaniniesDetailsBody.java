package www.gift_vouchers.com.main_screen.ui.details.model;//
//  CompaniniesDetailsBody.java
...
public class CompaniniesDetailsBody{

	@SerializedName("birthdate")
	private String birthdate;
	@SerializedName("category")
	private CompaniniesDetailsCategory[] category;
	...
	public void setCategory(CompaniniesDetailsCategory[] category){
		this.category = category;
	}
	public CompaniniesDetailsCategory[] getCategory(){
	 ...
	 */
	public CompaniniesDetailsBody(JSONObject jsonObject){
		if(jsonObject == null){
			return;
		}
		...
		if(categoryJsonArray != null){
			ArrayList<CompaniniesDetailsCategory> categoryArrayList = new ArrayList<>();
			for (int i = 0; i < categoryJsonArray.length(); i++) {
				JSONObject categoryObject = categoryJsonArray.optJSONObject(i);
				categoryArrayList.add(new CompaniniesDetailsCategory(categoryObject));
			}
			category = (CompaniniesDetailsCategory[]) categoryArrayList.toArray();
		}
	}
	...
	public JSONObject toJsonObject()
	{
		...
		try {
			...
			if(category != null && category.length > 0){
				...
				for(CompaniniesDetailsCategory categoryElement : category){
