...
public class UserInfoCoModelView extends ViewModel implements NetworkInterface {
    ...
    void get_data(String username, String phone, String email, String gold, String silver, String platinum, File file) {
        ...
        Call<UserInfoRootClass> call = networkis.upload_company("Bearer " + new saved_data().get_token(UserInfoModelViewFactory.context),
                username, email, phone_body, gold, silver, platinum, body);
    ...
    void save_local_data(String username, String email, String phone, String picture) {
        ...
        Observable.fromArray(arrayList).
            ...
            public void accept(ArrayList<String> arrayList) throws Throwable {
                ...
                //GO TO MAIN PAGE
                UserInfoModelViewFactory.context.startActivity(new Intent(UserInfoModelViewFactory.context, Main_Activity_Company.class));
